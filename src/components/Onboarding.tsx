...
const STEPS: OnboardingStep[] = [
  {
    title: "Добро пожаловать в Лабораторию Самости",
    description: "Это ваше личное пространство для глубокой внутренней работы. Давайте я покажу вам, как здесь всё устроено.",
  },
  {
    title: "Ваш Путь",
    description: "Здесь отображается ваш прогресс. Каждый этап открывает новую грань вашей личности. Дерево внизу растет вместе с вашим осознанием.",
    targetId: "onboarding-sidebar",
    arrowDirection: "left",
  },
  {
    title: "Карта Пути",
    description: "Здесь визуализирована вся дорога. Вы можете нажать на любой пройденный этап, чтобы вернуться к нему.",
    targetId: "onboarding-map",
    arrowDirection: "up",
  },
  {
    title: "Рабочее Пространство",
    description: "Это ваше поле для творчества. Пишите свои мысли здесь, а затем нажмите кнопку внизу, чтобы получить инсайт от Куратора.",
    targetId: "onboarding-workspace",
    arrowDirection: "down",
  },
  {
    title: "Архив и Помощь",
    description: "Здесь хранятся все ваши прошлые записи, а также кнопка связи с Куратором для любых вопросов.",
    targetId: "onboarding-tools",
    arrowDirection: "left",
  },
  {
    title: "Начнем путешествие?",
    description: "Ваше Дерево Самости уже ждет первого жёлудя. Просто начните писать в поле ввода на первом этапе.",
  }
];
