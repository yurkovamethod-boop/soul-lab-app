...
const STEPS: OnboardingStep[] = [
  ...
  },
  {
    ...
    description: "Здесь вы пишете свои мысли и выполняете задания урока. После записи Куратор даст обратную связь.",
    targetId: "onboarding-workspace",
    arrowDirection: "down",
  },
  {
    title: "Дневник и Куратор",
    description: "В дневнике хранятся все ваши записи. Куратор доступен в любой момент — для вопросов, интерпретаций и поддержки.",
